          ...
          <div className="p-8 bg-white/60 dark:bg-[#1a0f2e]/60 rounded-3xl backdrop-blur-xl border border-slate-200 dark:border-slate-800 shadow-xl transition-all duration-500">
            {lang === "en" ? (
              <>
                ...
                <p className="mb-6">
                  Thanks to the open-source projects and libraries this site is built on. The source is released under the <a href="https://github.com/songnguxyz/songngu.xyz/blob/main/LICENSE.md" className="text-mxp-pink hover:text-mxp-pink/80 transition-colors duration-500">MIT licence</a> and available in the <a href="https://github.com/songnguxyz/songngu.xyz" className="text-mxp-pink hover:text-mxp-pink/80 transition-colors duration-500">GitHub repository</a>.
                </p>
              </>
            ) : (
              <>
